...
int main() {
    ...
    while (frame != NULL) {
        ...
        cvPutText(frame_now, avgspeed, cvPoint(380, 400), &font, CV_RGB(255, 255, 255));
        ///counting vehicle
        sprintf(countMob, "mobil %d ", counterMob);
        cvPutText(frame_now, countMob, cvPoint(380, 420), &font, CV_RGB(255, 255, 255));

        sprintf(countTruksed, "truk sedang %d ", counterTruksed);
        cvPutText(frame_now, countTruksed, cvPoint(380, 440), &font, CV_RGB(255, 255, 255));

        sprintf(countTrukbes, "truk besar / bis %d ", counterTrukbes);
        cvPutText(frame_now, countTrukbes, cvPoint(380, 460), &font, CV_RGB(255, 255, 255));
